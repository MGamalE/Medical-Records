...
public class PatientDetailsActivity extends AppCompatActivity {
    ...
    Toolbar toolbar;
    EditText patientNameInput, patientAgeInput, patientHeightInput, patientWeightInput, patientDiagnosis, patientSSNInput, patientAddressInput;
    ...
    private void setIntentData() {
        if (getIntent().hasExtra("patientData")) {
            ...
            patientDiagnosis.setText(patient.getPatientDiagnosises());
    ...
    private void setImages(final Patient patient) {
        ...
        image1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(PatientDetailsActivity.this, FullScreenImageViewer.class);
    ...
    public void saveFileToStorage(Patient data) {
        ...
        if (isStoragePermissionGranted()) { // check or ask permission
            ...
            try {
                ...
                String s="Name :"+data.getPatientName()+"\n"+"Age :"+data.getPatientAge()+"\n"+
                        "Phone :"+ data.getPatientPhone()+"\n"+"Pressure :"+data.getPatientPressure()+"\n"+
                        "Address :"+data.getPatientAddress()+"\n"+"Blood :"+data.getPatientBlood()+"\n"+
                        "Virus :"+data.getPatientVirus()+"\n"+"Gender :"+data.getPatientGender()+"\n"+
                        "Diabetes :"+data.getPatientDiabetes()+"\n"+"Diagnosises: "+data.getPatientDiagnosises();
