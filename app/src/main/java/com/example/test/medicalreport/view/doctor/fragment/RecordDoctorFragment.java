...
import com.example.test.medicalreport.view.doctor.adapter.EditPatiantAdapter;
...
public class RecordDoctorFragment extends Fragment {
    RecyclerView recyclerView;
    EditPatiantAdapter adapter;
    Patient patient;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.activity_show_paient, container, false);
    ...
    private void setupRecycler(List<Patient> patients) {
        ...
        adapter = new EditPatiantAdapter(getActivity(), patients);
