...
public class NurseHomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.activity_home_nurse, container, false);
    ...
    private void setupRecycler(List<Patient> patients) {
        ...
        nurseListAdapter = new NurseListAdapter(getActivity(), patients);
        recyclerView.setAdapter(nurseListAdapter);
        nurseListAdapter.notifyDataSetChanged();
